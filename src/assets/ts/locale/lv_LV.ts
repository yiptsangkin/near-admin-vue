export default {
    ...
    loginForm: {
        ...
        accountPlaceholder: 'Lūdzu, ievadiet kontu (noklusējuma konts ADMIN)',
        passwordPlaceholder: 'Lūdzu, ievadiet paroli (noklusējuma parole 123456)',
        autoLogin: 'automātiska pieteikšanās',
        forgetBtn: 'Aizmirsi paroli',
