export default {
    ...
    loginForm: {
        ...
        accountPlaceholder: 'Kérjük, adja meg a fiókot (alapértelmezett fiók: ADMIN)',
        passwordPlaceholder: 'Kérjük, adja meg a jelszót (alapértelmezett jelszó 123456)',
        autoLogin: 'automatikus bejelentkezés',
        forgetBtn: 'Elfelejtette a jelszavát',
        loginBtn: 'Belépés',
        byAccountTip: {
