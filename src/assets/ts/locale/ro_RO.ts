export default {
    ...
    loginForm: {
        ...
        accountPlaceholder: 'Vă rugăm să introduceți contul (cont implicit ADMIN)',
        passwordPlaceholder: 'Vă rugăm să introduceți parola (parola implicită 123456)',
        autoLogin: 'Logare automata',
        forgetBtn: 'Ați uitat parola',
