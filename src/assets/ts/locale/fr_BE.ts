export default {
    ...
    loginForm: {
        ...
        accountPlaceholder: 'Veuillez saisir le compte (compte par défaut ADMIN)',
        passwordPlaceholder: 'Veuillez saisir le mot de passe (mot de passe par défaut 123456)',
    ...
    sysInfo: {
        sysIntro: 'Un cadre de développement front-end central et back-end utile basé sur Vue et Ant Design'
    },
    requestInfo: {
