export default {
    ...
    loginForm: {
        ...
        accountPlaceholder: 'الرجاء إدخال الحساب (الحساب الافتراضي ADMIN)',
        passwordPlaceholder: 'الرجاء إدخال كلمة المرور (كلمة المرور الافتراضية 123456)',
        autoLogin: 'تسجيل تلقائى',
        forgetBtn: 'هل نسيت كلمة السر',
        loginBtn: 'تسجيل دخول',
        byAccountTip: {
