export default {
    ...
    loginForm: {
        ...
        accountPlaceholder: 'Bitte geben Sie das Konto ein (Standardkonto ADMIN)',
        passwordPlaceholder: 'Bitte geben Sie das Passwort ein (Standard Passwort 123456)',
        ...
        validPlaceholder: 'Bestätigungs-Code',
