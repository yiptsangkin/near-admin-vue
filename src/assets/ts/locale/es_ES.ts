export default {
    ...
    loginForm: {
        ...
        accountPlaceholder: 'Ingrese la cuenta (cuenta predeterminada ADMIN)',
        passwordPlaceholder: 'Introduzca la contraseña (contraseña predeterminada 123456)',
        autoLogin: 'ingreso automático',
        forgetBtn: 'Se te olvidó tu contraseña',
