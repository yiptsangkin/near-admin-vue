export default {
    ...
    loginForm: {
        ...
        accountPlaceholder: 'Vinsamlegast sláðu inn reikninginn (sjálfgefið ADMIN reikningur)',
        passwordPlaceholder: 'Vinsamlegast sláðu inn lykilorðið (sjálfgefið lykilorð 123456)',
    ...
    sysInfo: {
        sysIntro: 'Gagnlegur miðju- og afturendan framþróunarrammi byggður á Vue og Maurhönnun'
    },
    requestInfo: {
