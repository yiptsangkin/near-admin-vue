export default {
    ...
    loginForm: {
        ...
        byPhoneBtn: 'Login do número do celular',
        accountPlaceholder: 'Insira a conta (conta padrão ADMIN)',
        passwordPlaceholder: 'Por favor, digite a senha (senha padrão 123456)',
    ...
    sysInfo: {
        sysIntro: 'Uma estrutura de desenvolvimento de front-end de back-end e meio útil baseada em Vue e Ant Design'
    },
    requestInfo: {
