export default {
    ...
    loginForm: {
        ...
        accountPlaceholder: 'Introduïu el compte (compte predeterminat ADMINISTRADOR)',
        passwordPlaceholder: 'Introduïu la contrasenya (contrasenya predeterminada 123456)',
        autoLogin: 'inici de sessió automàtic',
        forgetBtn: 'Has oblidat la contrasenya',
