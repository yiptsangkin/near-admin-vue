export default {
    ...
    loginForm: {
        ...
        accountPlaceholder: 'Inserisci l\'account (account predefinito ADMIN)',
        passwordPlaceholder: 'Immettere la password (password predefinita 123456)',
        autoLogin: 'login automatico',
        forgetBtn: 'Ha dimenticato la password',
        loginBtn: 'accesso',
        byAccountTip: {
    ...
    sysInfo: {
        sysIntro: 'Un utile framework di sviluppo front-end middle e back-end basato su Vue e Ant Design'
    },
    requestInfo: {
