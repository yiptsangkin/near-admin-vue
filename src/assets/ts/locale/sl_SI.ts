export default {
    ...
    loginForm: {
        ...
        accountPlaceholder: 'Vnesite račun (privzeti račun ADMIN)',
        passwordPlaceholder: 'Vnesite geslo (privzeto geslo 123456)',
        autoLogin: 'samodejna prijava',
        forgetBtn: 'Ste pozabili geslo',
        loginBtn: 'Vpiši se',
        byAccountTip: {
        ...
        validPlaceholder: 'Verifikacijska koda',
