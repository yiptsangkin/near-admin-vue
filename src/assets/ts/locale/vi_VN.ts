export default {
    ...
    loginForm: {
        ...
        accountPlaceholder: 'Vui lòng nhập tài khoản (ADMIN tài khoản mặc định)',
        passwordPlaceholder: 'Vui lòng nhập mật khẩu (mật khẩu mặc định 123456)',
