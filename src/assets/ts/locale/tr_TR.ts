export default {
    ...
    loginForm: {
        ...
        accountPlaceholder: 'Lütfen hesabı girin (varsayılan hesap ADMIN)',
        passwordPlaceholder: 'Lütfen şifreyi girin (varsayılan şifre 123456)',
        autoLogin: 'otomatik giriş',
        forgetBtn: 'Parolanızı mı unuttunuz',
        loginBtn: 'oturum aç',
        byAccountTip: {
