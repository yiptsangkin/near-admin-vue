export default {
    ...
    loginForm: {
        ...
        accountPlaceholder: 'Silakan masukkan akun (akun default ADMIN)',
        passwordPlaceholder: 'Silakan masukkan kata sandi (kata sandi default 123456)',
        autoLogin: 'masuk otomatis',
        forgetBtn: 'Tidak ingat kata sandi',
        loginBtn: 'Gabung',
        byAccountTip: {
