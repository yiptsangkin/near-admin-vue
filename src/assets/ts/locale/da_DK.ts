export default {
    ...
    loginForm: {
        ...
        accountPlaceholder: 'Indtast venligst kontoen (standardkonto ADMIN)',
        passwordPlaceholder: 'Indtast adgangskoden (standardadgangskode 123456)',
        autoLogin: 'automatisk login',
        forgetBtn: 'Glemt kodeord',
        loginBtn: 'Log på',
        byAccountTip: {
