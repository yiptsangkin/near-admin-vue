export default {
    ...
    loginForm: {
        ...
        accountPlaceholder: 'Voer het account in (standaard account ADMIN)',
        passwordPlaceholder: 'Voer het wachtwoord in (standaard wachtwoord 123456)',
    ...
    logline: {
        ...
        error: {
            ...
            confirm: 'Wilt u het logboek wissen? (Als het logboek is geleegd, kan het niet worden opgehaald)'
        },
