export default {
    ...
    loginForm: {
        ...
        accountPlaceholder: 'ದಯವಿಟ್ಟು ಖಾತೆಯನ್ನು ನಮೂದಿಸಿ (ಡೀಫಾಲ್ಟ್ ಖಾತೆ ADMIN)',
        passwordPlaceholder: 'ದಯವಿಟ್ಟು ಪಾಸ್ವರ್ಡ್ ಅನ್ನು ನಮೂದಿಸಿ (ಡೀಫಾಲ್ಟ್ ಪಾಸ್ವರ್ಡ್ 123456)',
        autoLogin: 'ಸ್ವಯಂ ಲಾಗಿನ್',
        forgetBtn: 'ಪಾಸ್ವರ್ಡ್ ಮರೆತಿರಾ',
