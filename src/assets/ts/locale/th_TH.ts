export default {
    ...
    tagObj: {
        ...
        checkSave: 'คุณต้องการปิดหน้านี้หรือไม่?(โปรดตรวจสอบให้แน่ใจว่าได้บันทึกเนื้อหาของหน้าเว็บที่ทำเครื่องหมายเป็นสีแดงแล้ว)',
    ...
    logline: {
        ...
        error: {
            ...
            confirm: 'คุณต้องการล้างบันทึกหรือไม่(หากไฟล์บันทึกถูกลบจะไม่สามารถเรียกคืนได้)'
        },
